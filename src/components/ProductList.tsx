    ...
    try {
      ...
      const response = await fetch("/api/print-labels", {
        ...
        body: JSON.stringify({
          ...
          products: productsToPrint, // Include all product details, including pricePerUnit
          userId: userId,
        }),
      });
    ...
    <div className="p-6 bg-white shadow-md rounded-lg">
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          ...
          disabled={
            !selectedTemplate || selectedProducts.length === 0 || printLoading
          }
                    ...
                    <>
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        <input
                          type="text"
                          name="productNameEst"
                          value={editValues.productNameEst || ""}
                          onChange={handleEditChange}
                          className="w-full p-1 border rounded"
                        />
                      </td>
